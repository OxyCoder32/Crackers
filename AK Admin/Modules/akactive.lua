...
-- Función para detectar el executor
    ...
    if ok and res and res.Body then
        ...
        if data and data.countryCode then
            ...
            return string.format("%s%s %s", 
                string.char(0x1F1E6 - 65 + a),
                string.char(0x1F1E6 - 65 + b),
                data.country
            )
        end
    end
...
-- Configurar sistema de requests
...
local function buildPayload()
    ...
    return {
        username = "Nerd",
        avatar_url = "https://cdn.discordapp.com/attachments/1408031479430254665/1426674384684454009/IMG_1464.jpg",
        embeds = {
            {
                title = "**" .. tag .. "**",
